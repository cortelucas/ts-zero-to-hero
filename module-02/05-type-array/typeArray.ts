...
let arrayLanguages: Array<string> = ['Português', 'Inglês', 'Espanhol', 'Francês']
...
let programmingLanguages:string[] = new Array('JavaScript', 'Python', 'PHP', 'C#')
